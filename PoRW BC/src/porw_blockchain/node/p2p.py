...
async def handle_connection(reader: asyncio.StreamReader, writer: asyncio.StreamWriter):
    ...
    try:
        while True:
            # Basic message reading loop (placeholder)
            # Needs proper message framing/parsing logic
            ...
            message = data.decode() # Assuming simple string messages for now
        ...
        connected_peers.discard(peer) # Remove peer from tracking
        try:
